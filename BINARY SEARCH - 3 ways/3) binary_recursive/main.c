...
int main(int argc, char *argv[]) {
	...
	binary_search(array, searched_val, first, last);	
	
	return 0;
}

void binary_search(int* array, int searched_val, int first, int last){
	...
	if(first <= last){
		...
		printf("Sorry, value %d not found in array.", searched_val);
